...
Find below a list of  `composed` commands added with the  `x/revenue` module. You can obtain the full list by using the `composed -h` command. A CLI command can look like this:

```bash
composed query revenue params
```
