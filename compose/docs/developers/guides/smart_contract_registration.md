...
composed tx revenue register $CONTRACT $NONCE $WITHDRAWER \
...
```bash
# Check revenues
composed q revenue contract $CONTRACT
```
...
composed tx revenue update $CONTRACT $WITHDRAWER \
...
composed tx revenue cancel $CONTRACT \
--gas=700000 --gas-prices=10000pose \
--from=mm
```
