...
```bash
$ composed keys add dev0-restored --recover
...
```bash
composed keys unsafe-export-eth-key dev0 > dev0.export
...
```bash
$ composed keys import dev0-imported ./dev0.export
Enter passphrase to decrypt your key:
```
...
```
$ composed keys unsafe-import-eth-key dev0-imported ./dev0.export
