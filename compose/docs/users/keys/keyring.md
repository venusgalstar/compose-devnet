...
MY_VALIDATOR_ADDRESS=$(composed keys show dev0 -a)
```
...
yes $KEYPASSWD | composed keys add me
yes $KEYPASSWD | composed keys show me
# start composed with keyring-backend flag
composed --keyring-backend=file start
```
