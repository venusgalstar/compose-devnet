...
# Initialize chain.
composed init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.composed/config/

wget -O ~/.composed/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
